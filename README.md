...
│ ├── CS-370-Current-Trends-in-CS/
│ ├── CS-465-Full-Stack-Development-I/
│ └── CS-499-Capstone/
│
├── 🧮 Math & Statistics/
│ ├── MAT-230-Discrete-Mathematics/
│ ├── MAT-243-Applied-Statistics/
│ └── MAT-350-Applied-Linear-Algebra/
│
├── 🔬 Science/
│ ├── PHY-150-Intro-Physics/
│ └── Science-Elective/
│
├── 💻 IT & Electives/
│ ├── IT-140-Intro-to-Scripting/
│ ├── IT-212-Computer-Networking/
│ ├── IT-315-Object-Oriented-Analysis-Design/
...
- **guide.md** — Survival guide with expectations, flow, pitfalls, and tips
- **resources.md** — Textbooks, tools, tutorials, and helpful links  
- **success.md** — Keys to success and rubric checklists
...
- **Real SNHU Course Data** — Based on actual syllabi, prerequisites, and student experiences
- **Comprehensive Coverage** — 19 courses covering the entire CS program
- **Practical Examples** — Database schemas, network diagrams, code samples, and project templates
- **Success-Focused** — Each course includes specific tips for getting an A
